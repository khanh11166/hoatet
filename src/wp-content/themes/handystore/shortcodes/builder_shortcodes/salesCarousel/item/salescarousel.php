		...
		public function element_items() {
			$this->items = array(
				'Notab' => array(
					...
					array(
                        'name' 	  => __( "Enter Sale Product ID",  'plumtree' ),
                        'id'      => 'product_id',
						'type'    => 'text_field',
						'class'   => 'jsn-input-xxlarge-fluid',
                        'std'     => '',
					...
					array(
						'name'    => __( 'Target Date',  'plumtree' ),
						'id'      => 'target_date',
						'type'    => 'text_field',
						'class'   => 'jsn-input-xxlarge-fluid',
						'std'     => __( '2015-12-26',  'plumtree' ),
						'tooltip' => __( 'Set target date (YYYY-MM-DD) when special offer ends',  'plumtree' )
					),
					array(
						'name'    => __( 'Pre-Countdown text',  'plumtree' ),
