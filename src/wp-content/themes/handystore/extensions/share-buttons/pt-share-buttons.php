...
function pt_share_scripts() {
	wp_enqueue_script( 'pt_share_post', get_template_directory_uri().''.str_replace(str_replace('\\', '/', get_template_directory()), '',str_replace('\\', '/', __DIR__)).'/js/post-share.js', array('jquery'), '1.0', true );
