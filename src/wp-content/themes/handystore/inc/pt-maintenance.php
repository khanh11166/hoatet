...
<head>
	...
	<body>
		...
		<?php if (get_option('site_logo')): ?>
			<div class="site-logo">
				<img src="<?php echo esc_url(get_option('site_logo')) ?>" alt="<?php esc_attr(bloginfo( 'description' )); ?>" title="<?php esc_attr(bloginfo( 'name' )); ?>" />
			</div>
		<?php else: ?>
			<div class="site-logo">
		...
		<div class="msg-wrapper">
			...
			<?php $target_date = get_option('maintenance_countdown');
