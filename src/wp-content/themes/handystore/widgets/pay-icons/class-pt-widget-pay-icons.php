...
class pt_pay_icons_widget extends WP_Widget {
	...
	?>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e( 'Title:', 'plumtree' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id ('precontent')); ?>"><?php _e('Pre-Content', 'plumtree'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id ('postcontent')); ?>"><?php _e('Post-Content', 'plumtree'); ?></label>
