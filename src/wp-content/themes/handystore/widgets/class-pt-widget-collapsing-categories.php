...
class pt_collapsing_categories extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__('PT Collapsing Categories', 'plumtree'), // Name
			array('description' => __( "Plum Tree special widget. Display configurable accordion with categories on your site.", "plumtree" ), ) 
		);
	}
