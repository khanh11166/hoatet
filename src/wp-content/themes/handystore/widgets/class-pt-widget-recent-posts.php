...
class pt_recent_post_widget extends WP_Widget {
	...
	?>
		...
		<p>
			...
			<input size="3" id="<?php echo esc_attr( $this->get_field_id('post-quantity') ); ?>" name="<?php echo $this->get_field_name('post-quantity'); ?>" type="number" value="<?php echo esc_attr( $instance['post-quantity'] ); ?>" />
		</p>
		<p>
            <label for="<?php echo $this->get_field_id('post-type'); ?>"><?php _e('Show Posts for next Post Type:', 'plumtree');?></label>
            <select class="widefat" id="<?php echo esc_attr($this->get_field_id('post-type')); ?>" name="<?php echo $this->get_field_name('post-type'); ?>">
                <?php
        ...
        <p>
        	...
        	<select class="widefat" id="<?php echo esc_attr($this->get_field_id("sort-by")); ?>" name="<?php echo $this->get_field_name("sort-by"); ?>">
        ...
        <p>
    	    <input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id("sort-order")); ?>" name="<?php echo $this->get_field_name("sort-order"); ?>" <?php checked( (bool) $instance["sort-order"] ); ?> />
            <label for="<?php echo $this->get_field_id("sort-order"); ?>"><?php _e( 'Reverse sort order (ascending)?', 'plumtree' ); ?></label>
        </p>
        <p>
            <input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id("date")); ?>" name="<?php echo $this->get_field_name("date"); ?>"<?php checked( (bool) $instance["date"] ); ?> />
            <label for="<?php echo $this->get_field_id("date"); ?>"><?php _e( 'Show publish date?', 'plumtree' ); ?></label>
        </p>
        <p>
            <input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id("cats")); ?>" name="<?php echo $this->get_field_name("cats"); ?>"<?php checked( (bool) $instance["cats"] ); ?> />
            <label for="<?php echo $this->get_field_id("cats"); ?>"><?php _e( 'Show list of post Categories?', 'plumtree' ); ?></label>
        </p>
        <p>
            <input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id("comments")); ?>" name="<?php echo $this->get_field_name("comments"); ?>"<?php checked( (bool) $instance["comments"] ); ?> />
		...
		<p>
			...
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('category') ); ?>" name="<?php echo $this->get_field_name('category'); ?>" type="text" value="<?php echo esc_attr( $instance['category'] ); ?>" />
		</p>              
        <p>
            <input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id("thumb")); ?>" name="<?php echo $this->get_field_name("thumb"); ?>"<?php checked( (bool) $instance["thumb"] ); ?> />
            <label for="<?php echo $this->get_field_id("thumb"); ?>"><?php _e( 'Show post thumbnail?', 'plumtree' ); ?></label>
        </p>
        <p>
            <input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id("excerpt")); ?>" name="<?php echo $this->get_field_name("excerpt"); ?>"<?php checked( (bool) $instance["excerpt"] ); ?> />
        ...
        <p>
            ...
            <input type="text" id="<?php echo esc_attr($this->get_field_id("excerpt-length")); ?>" name="<?php echo $this->get_field_name("excerpt-length"); ?>" value="<?php echo esc_attr( $instance['excerpt-length'] ); ?>" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id("excerpt-more"); ?>"><?php _e( 'Excerpt read more text:', 'plumtree' ); ?></label>
            <input class="widefat" type="text" id="<?php echo esc_attr($this->get_field_id("excerpt-more")); ?>" name="<?php echo $this->get_field_name("excerpt-more"); ?>" value="<?php echo esc_attr( $instance['excerpt-more'] ); ?>" size="10" />
        </p>
        <p>
            <input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id("price")); ?>" name="<?php echo $this->get_field_name("price"); ?>"<?php checked( (bool) $instance["price"] ); ?> />
				...
				<div class="content-wrapper">
					...
					<div class="recent-posts-entry-meta">
						...
						<?php if ($show_comments) :?>
							<div class="comments-qty"><i class="fa fa-comments-o"></i><?php comments_popup_link( __('No comments yet', 'plumtree'), __('1 comment', 'plumtree'), __('% comments', 'plumtree'), 'comments-link', __('Comments are off', 'plumtree')); ?></div>
